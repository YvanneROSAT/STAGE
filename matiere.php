...
<div class="row">
  <div class="col p-4">
    ...
    echo "<tr>";
    echo "<th onclick='sortTable(0)' scope='col'>codeMatiere</th>";
    echo "<th onclick='sortTable(0)' scope='col'>nomMatiere</th>";
    echo "<th onclick='sortTable(0)' scope='col'>abregeMatiere</th>";
    ...
    foreach ($liste as $unApprenant) {
      ...
      echo "<tr>";
      echo "<td>" . $unApprenant['codeMatiere'] . "</td>";
      echo "<td>" . $unApprenant['nomMatiere'] . "</td>";
      echo "<td>" . $unApprenant['abregeMatiere'] . "</td>";
      echo "</tr>";
    }
